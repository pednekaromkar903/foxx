...
(async () => {
  ...
  try {
    console.log('Seeding via JS script...');
    ...
    await prisma.user.create({ data: { id: 'admin1', email: 'admin@atomberg.com', name: 'Ravi Kumar', role: 'ADMIN', departmentId: 'dept_eng', password: adminPwd } });
    await prisma.user.create({ data: { id: 'mgr1', email: 'manager@atomberg.com', name: 'Priya Singh', role: 'MANAGER', departmentId: 'dept_eng', password: managerPwd } });
    await prisma.user.create({ data: { id: 'mgr2', email: 'neha@atomberg.com', name: 'Neha Gupta', role: 'MANAGER', departmentId: 'dept_des', password: commonPwd } });

    await prisma.user.create({ data: { id: 'emp1', email: 'amit@atomberg.com', name: 'Amit Sharma', role: 'EMPLOYEE', departmentId: 'dept_eng', managerId: 'mgr1', password: employeePwd } });
    await prisma.user.create({ data: { id: 'emp2', email: 'sneha@atomberg.com', name: 'Sneha Rao', role: 'EMPLOYEE', departmentId: 'dept_des', managerId: 'mgr1', password: commonPwd } });
    await prisma.user.create({ data: { id: 'emp3', email: 'rahul@atomberg.com', name: 'Rahul Verma', role: 'EMPLOYEE', departmentId: 'dept_eng', managerId: 'mgr1', password: commonPwd } });
    await prisma.user.create({ data: { id: 'emp4', email: 'tina@atomberg.com', name: 'Tina Das', role: 'EMPLOYEE', departmentId: 'dept_mkt', managerId: 'mgr2', password: commonPwd } });
    ...
    const goals = [
      { id: "g1", employeeId: "emp1", title: "Reduce API P99 latency", description: "Lower from 20ms to target", thrustArea: "Performance", uomType: 'NUMERIC_MAX', target: 20, weightage: 15, status: 'APPROVED_LOCKED', quarter: 'Q2', year: 2026, deadline: new Date("2026-06-30T23:59:59Z") },
    ...
    const updates = [
      { id: "u1", goalId: "g1", quarter: 'Q2', achievement: 15, status: 'ON_TRACK', comment: "Optimized caching layer", progressScore: 100 },
      { id: "u2", goalId: "g2", quarter: 'Q2', achievement: 0, status: 'COMPLETED', comment: "Zero incidents this quarter", progressScore: 100 },
      { id: "u3", goalId: "g3", quarter: 'Q2', achievement: 87, status: 'ON_TRACK', comment: "Most PRs reviewed", progressScore: 87 },
      { id: "u4", goalId: "g7", quarter: 'Q2', achievement: 28, status: 'ON_TRACK', comment: "28 components built", progressScore: 70 },
      { id: "u5", goalId: "g8", quarter: 'Q2', achievement: 32, status: 'COMPLETED', comment: "Exceeded target", progressScore: 106.7 },
      { id: "u6", goalId: "g9", quarter: 'Q2', achievement: 25, status: 'AT_RISK', comment: "Inconsistency score worsened", progressScore: 40 },
      { id: "u7", goalId: "g11", quarter: 'Q2', achievement: 100, status: 'COMPLETED', comment: "Full coverage achieved", progressScore: 100 },
      { id: "u8", goalId: "g12", quarter: 'Q2', achievement: 3, status: 'BLOCKED', comment: "3 vulns found in audit", progressScore: 0 },
      { id: "u9", goalId: "g13", quarter: 'Q2', achievement: 7.2, status: 'ON_TRACK', comment: "7.2% engagement rate", progressScore: 84.7 }
    ];
